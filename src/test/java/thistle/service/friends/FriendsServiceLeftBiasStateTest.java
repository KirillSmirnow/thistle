...
public class FriendsServiceLeftBiasStateTest {
    ...
    /**
     * {@link #follower}.id must be less than {@link #followee}.id
     */
    @Before
    public void init() {
        ...
        assertEquals(Friendship.Bias.LEFT, friendshipRepository.find(follower, followee).get().getBias());
    }
